...
<img src="minas2.png" width="650" height="500"/> 
---
...
You can use the [editor on GitHub](https://github.com/rladiesrp/rladiesrp.github.io/edit/main/README.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/rladiesrp/rladiesrp.github.io/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
